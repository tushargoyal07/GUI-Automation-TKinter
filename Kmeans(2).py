...
def data():
    global filename
    filename = askopenfilename(initialdir=r"C:\Users\WELCOME\Downloads",title = "Select file")
...
def files():
    with open(r"C:\Users\WELCOME\Desktop\model_summary","w",encoding="utf-8") as file:
